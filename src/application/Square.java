...
public class Square extends PrimitiveObstacle {
	//private ImageView SquareAdd;
	public Square() {
		Image SquareObstacle = new Image("model/resources/SquareObstacle.png");
		obImg = new ImageView(SquareObstacle);
